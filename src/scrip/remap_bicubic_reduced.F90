...
! EOP
!-----------------------------------------------------------------------
! $Id: remap_bicubic_reduced.F90 21 2003-11-14 11:21:27Z gayler $
! $Author: gayler $
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
    ...
    DO ib_dst_add = 1, grid2_size ! for each target point
	  ...
	  DO ib_i=il_min, il_max		 	   
		...
		rl_distance = &
		   ACOS(rl_coslat_dst*COS(grid1_center_lat(ib_i))* &
...
!-----------------------------------------------------------------------   
	...
	bin=num_srch_red
	ila_corners(1,1) = bin_lats_r(1,num_srch_red-1)
	ila_corners(1,2) = bin_lats_r(2,num_srch_red-1)
	ila_corners(2,1) = bin_lats_r(1,num_srch_red)
	ila_corners(2,2) = bin_lats_r(2,num_srch_red)
	...
	bin=num_srch_red-1
	ila_corners(1,1) = bin_lats_r(1,num_srch_red-2)
	ila_corners(1,2) = bin_lats_r(2,num_srch_red-2)
	ila_corners(2,1) = bin_lats_r(1,num_srch_red-1)
	ila_corners(2,2) = bin_lats_r(2,num_srch_red-1)
	ila_corners(3,1) = bin_lats_r(1,num_srch_red)
	ila_corners(3,2) = bin_lats_r(2,num_srch_red)
	ila_corners(4,1:2) = 0 	  
    ...
    rda_src_lats(:)= grid1_center_lat(ila_corners(:,1))
