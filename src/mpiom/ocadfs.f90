...
175    CONTINUE
!
      CALL bounds_exch('p',T1O)
      CALL bounds_exch('p',S1O)
!
       FOURTH=0.25
!
!
...
!     
     ...
     &        +VSU*S1O(I,J+1,K)+VNO*S1O(I,J-1,K))/GEW
       ...
       ENDDO
      ENDDO
      CALL bounds_exch('p',TINF)
      CALL bounds_exch('p',SINF)
!
#endif
!
!
!     Calculate some auxiliary arrays
      ...
      CALL bounds_exch('u+',DLXP2)
      CALL bounds_exch('v+',DLYP2)
      ...
      CALL bounds_exch('u+',DSX)
      CALL bounds_exch('u+',DTX)
      CALL bounds_exch('v+',DSY)
      CALL bounds_exch('v+',DTY)
#endif
...
#endif
!
      CALL bounds_exch('p',CURVLOT)
      CALL bounds_exch('p',CURVLOS)
!
#ifdef QUICK2
      DO J=2,JE1
       DO I=2,IE1
...
!
     ...
     &     *DLYP(I,J)*DLYP(I,J+1)/(DLYP2(I,J-1)+DLYP2(I,J))
      ...
      CALL bounds_exch('v+',CURVSOT)
      call bounds_exch('v+',CURVSOS)
      ...
      CALL bounds_exch('v+',CURVNOT)
      call bounds_exch('v+',CURVNOS)
...
!
      ...
      CALL bounds_exch('u+',CURVEAT)
      CALL bounds_exch('u+',CURVEAS)
      ...
      CALL bounds_exch('u+',CURVWET)
      CALL bounds_exch('u+',CURVWES)
#endif
#ifdef QUICK
      DO J=2,JE1
       DO I=2,IE1
...
185    CONTINUE
!
      CALL bounds_exch('p',UK1O)
      CALL bounds_exch('p',VK1E)
!
       DO K=1,KE
        DO J=1,JE
         DO I=1,IE
