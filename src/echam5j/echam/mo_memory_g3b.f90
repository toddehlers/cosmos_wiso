...
CONTAINS
  ...
  SUBROUTINE construct_g3b
    ...
    CALL add (g3b,'wind10w', wind10w   ,code=159,lpost=.TRUE.,longname='10m windspeed over water'               ,units='m/s'      )
    ...
    END IF
    CALL add (g3b,'ocu',  ocu    ,code= 83, lpost=.FALSE.,                              &
         longname='ocean eastw. velocity',bits=24,units='m/s',contnorest=.true. )
    CALL add (g3b,'ocv',  ocv    ,code= 84, lpost=.FALSE.,                              &
