...
!vg  zd =
!vg  FLOOR(365.25_dp*iy)     :  number of days in previous years since year 0;
!vg                             leap year every fourth year
!vg + INT(30.6001_dp*(im+1)) :  number of days in previous months of the year
!vg                             note: im /= km; iy /= ky 
!vg + 1720996.5_dp           :  offset between julian day 0 (Nov. 24th,-4713)
!vg                             and Oct. 29th of year -1 (together with extra 
!vg                             days of previous term this is the offset to 
!vg                             Jan 1st of year 0)
!vg + REAL(kd,dp)            :  number of days in current month
!vg + REAL(ib,dp)            :  correction term: no leap years every 100 years,
!vg                             but leap year every 400 years
!vg + zsec
